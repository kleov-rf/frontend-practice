...
export const shared_passion = {
  title:
    "Making music isn't easy. It takes time, effort, and learning. But when you're in the flow, it's incredibly rewarding.",
  description: [
    'We feel the same way about making Ableton products. The driving force behind Ableton is our passion for what we make, and the people make it for.',
  ],
}
...
export const global_team = {
  ...
  description: [
    'Most of us are active musicians, producers, and DJs, and many of us use Live and PUsh every day. We come from a wide range of cultural and professional backgrounds. Some of us have PhDs, some are self-taught, and most of us are somewhere in between. What connects us is the shared belief that each of us has the skills and knowledge to contribute to something big: ehlping to shape the future of music culture.',
  ],
}

export const focused_excellence = {
  title:
...
export const passionate_growth = {
  title:
...
export const employee_welcoming = {
  title:
